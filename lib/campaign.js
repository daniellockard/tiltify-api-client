...
class Campaign {
   ...
   */
  get (id, callback) {
    this._doRequest(`campaigns/${id}`).then((response) => {
  ...
  getRecentDonations (id, callback) {
    this._doRequest(`campaigns/${id}/donations`).then((response) => {
      callback(response.data.data)
    })
  }
  ...
  getDonations (id, callback) {
    this._sendRequest(`campaigns/${id}/donations?limit=100`, callback)
  }
  ...
  getDonationMatches (id, callback) {
    this._sendRequest(`campaigns/${id}/donation_matches?limit=100`, callback)
  }
  ...
  getRewards (id, callback) {
    this._sendRequest(`campaigns/${id}/rewards?limit=100`, callback)
  }
  ...
  getPolls (id, callback) {
    this._sendRequest(`campaigns/${id}/polls?limit=100`, callback)
  }
  ...
  getChallenges (id, callback) {
    ...
    this._sendRequest(`campaigns/${id}/targets?limit=100`, callback)
  }
  ...
  getMilestones (id, callback) {
    this._sendRequest(`campaigns/${id}/milestones?limit=100`, callback)
  }
  ...
  getSchedule (id, callback) {
    this._sendRequest(`campaigns/${id}/schedules?limit=100`, callback)
  }
}
