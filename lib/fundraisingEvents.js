...
class FundraisingEvents {
  ...
  get (id) {
    return new Promise((resolve, reject) => {
      this._sendRequest(`public/fundraising_events/${id}`, resolve)
    })
  }
  ...
  getCampaigns (id) {
    return new Promise((resolve, reject) => {
      this._sendRequest(`public/fundraising_events/${id}/supporting_events?limit=100`, resolve)
    })
  }
  ...
  getTopDonors (id, timeType) {
    return new Promise((resolve, reject) => {
      this._sendRequest(`public/fundraising_events/${id}/donor_leaderboard${timeType ? '?time_type=' + timeType : ''}`, resolve)
    })
  }
  ...
  getLeaderboards (id, timeType) {
    return new Promise((resolve, reject) => {
      this._sendRequest(`public/fundraising_events/${id}/user_leaderboard${timeType ? '?time_type=' + timeType : ''}`, resolve)
    })
  }
}
