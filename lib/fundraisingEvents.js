...
class FundraisingEvents {
  ...
  getTopDonors (id, timeType, callback) {
    this._sendRequest(`fundraising_events/${id}/donor_leaderboard${timeType ? '?time_type' + timeType : ''}`, callback)
  }
  ...
  getLeaderboards (id, timeType, callback) {
    this._sendRequest(`fundraising_events/${id}/user_leaderboard${timeType ? '?time_type' + timeType : ''}`, callback)
  }
}
